...
> **状态：**早期开源版本（manifest `0.1.0`；功能里程碑约 v0.14.x）。持续活跃开发中，变化较快。
...
| [功能清单.md](./功能清单.md) | 全量功能清单 |
| [开发进度.md](./开发进度.md) | 里程碑与版本历史 |
...
| v0.10.0 | 变更审查、Rules、Git 工作区、自动化 |
| v0.11.0 | Anthropic Extended Thinking |
| v0.12.0 | 子代理全链路编排 |
| v0.13.0 | Prompt Caching、工具审批 UI、自动路由、工具 schema 整合 |
| v0.14.x | 内置 CBM 代码图谱、自动上下文压缩、核心系统提示词模块化 |

规划中：数据库连接器、插件系统/市场、上下文缓存进一步优化。
