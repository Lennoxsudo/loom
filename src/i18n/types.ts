export interface I18nMessages {
  ...
  settingsAgentMemory: {
    ...
    enable: string;
    enableDesc: string;
    enableUserProfile: string;
    enableUserProfileDesc: string;
    enableNotes: string;
    enableNotesDesc: string;
    enableSessionSearch: string;
    enableSessionSearchDesc: string;
    enableReview: string;
    enableReviewDesc: string;
    ...
    pendingApproveFailed: string;
    pendingRejectFailed: string;
    storageHint: string;
    previewTitle: string;
    previewDesc: string;
    previewUser: string;
