...
export const COMPOSER_SELECTOR_MENU_ATTR = 'data-composer-selector-menu';
...
export function isComposerSelectorMenuTarget(target: EventTarget | null): boolean {
  return target instanceof Element && Boolean(target.closest(`[${COMPOSER_SELECTOR_MENU_ATTR}]`));
}
