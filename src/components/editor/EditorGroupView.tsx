  ...
  return (
    <div
      ...
      style={{
        ...
        overflow: 'hidden',
        borderLeft:
          showLeadingBorder && splitDirection === 'row'
            ? '1px solid var(--border-subtle)'
            : undefined,
        borderTop:
          showLeadingBorder && splitDirection === 'column'
            ? '1px solid var(--border-subtle)'
            : undefined,
      }}
    >
      ...
      <div
        style={{
          ...
          backgroundColor: isFocused
            ? 'var(--bg-header)'
            : 'color-mix(in srgb, var(--bg-header) 88%, var(--bg-primary))',
          display: 'flex',
              ...
              >
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    ol: ({ children }) => (
                      <ol
                        style={{ margin: '6px 0', paddingLeft: '20px', listStyleType: 'decimal' }}
                      >
                        {children}
                      </ol>
                    ),
                    ...
                    h1: ({ children }) => (
                      <div
                        style={{
                          ...
                          fontWeight: 700,
                          margin: '16px 0 8px',
                          color: themedMarkdownText.headingStrong,
                          borderBottom: `1px solid ${themedMarkdownText.border}`,
                          paddingBottom: '6px',
                        }}
                      >
                        {children}
                    ...
                    h4: ({ children }) => (
                      <div
                        style={{
                          ...
                          fontWeight: 600,
                          margin: '10px 0 4px',
                          color: themedMarkdownText.headingSoft,
                        }}
                      >
                        {children}
                      </div>
                    ...
                    h6: ({ children }) => (
                      <div
                        style={{
                          ...
                          fontWeight: 600,
                          margin: '8px 0 4px',
                          color: themedMarkdownText.subtle,
                        }}
                      >
                        {children}
                      </div>
                    ...
                    strong: ({ children }) => (
                      <strong style={{ fontWeight: 600, color: themedMarkdownText.headingStrong }}>
                        {children}
                      </strong>
                    ),
                    blockquote: ({ children }) => (
                      <blockquote
                        style={{
                          margin: '8px 0',
                          paddingLeft: '14px',
                          borderLeft: `3px solid ${themedMarkdownText.quoteBorder}`,
                          color: themedMarkdownText.subtle,
                          fontStyle: 'italic',
                        }}
                      >
                    ...
                    hr: () => (
                      <hr
                        style={{
                          border: 'none',
                          borderTop: `1px solid ${themedMarkdownText.border}`,
                          margin: '16px 0',
                        }}
                      />
                    ),
                    ...
                    thead: ({ children }) => (
                      <thead style={{ backgroundColor: themedMarkdownText.surface }}>
                        {children}
                      </thead>
                    ),
                    th: ({ children }) => (
                      <th
                        style={{
                          padding: '6px 12px',
                          border: `1px solid ${themedMarkdownText.border}`,
                          textAlign: 'left',
                          fontWeight: 600,
                          color: themedMarkdownText.headingStrong,
                        }}
